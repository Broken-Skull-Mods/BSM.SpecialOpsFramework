class When_Enemy {
    ...
    WoodlandRifleman[] = { O_G_Soldier_F };
    WoodlandGrenadier[] = { O_G_Soldier_GL_F };
    WoodlandMarksman[] = { O_G_Sharpshooter_F };
    WoodlandAutoRifleman[] = { O_G_Soldier_AR_F };
    WoodlandAntitank[] = { O_G_Soldier_LAT2_F };
    WoodlandHVT[] = { O_G_officer_F };
    
    WinterRifleman[] = { O_G_Soldier_F };
    WinterGrenadier[] = { O_G_Soldier_GL_F };
    WinterMarksman[] = { O_G_Sharpshooter_F };
    WinterAutoRifleman[] = { O_G_Soldier_AR_F };
    WinterAntitank[] = { O_G_Soldier_LAT2_F };
    WinterHVT[] = { O_G_officer_F };

    DesertRifleman[] = { O_G_Soldier_F };
    DesertGrenadier[] = { O_G_Soldier_GL_F };
    DesertMarksman[] = { O_G_Sharpshooter_F };
    DesertAutoRifleman[] = { O_G_Soldier_AR_F };
    DesertAntitank[] = { O_G_Soldier_LAT2_F };
    DesertHVT[] = { O_G_officer_F };
