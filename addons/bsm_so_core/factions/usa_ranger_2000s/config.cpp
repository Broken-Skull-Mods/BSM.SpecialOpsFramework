...
class CfgPatches
{
	class bm_specops_faction_US_RANGER_2000
	{
		...
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]={"rhsusf_c_weapons","ace_compat_rhs_usf3_arsenal","Blastcore_MainCore","ace_compat_rhs_usf3","JSOC_Uniforms","ace_attach","ace_hearing","ace_medical_treatment","tfa_jpc","A3_Weapons_F","ace_realisticnames","ace_dagr","ace_trenches","ace_logistics_wirecutter","ace_explosives","rhsusf_c_troops","ace_vector","tfar_handhelds","USP_Gear_NVG","CUP_Weapons_Mk48","CUP_Weapons_West_Attachments","CUP_Weapons_Ammunition","ace_overheating","ace_compat_rhs_usf3_scopes","ace_kestrel4500","ace_rangecard","ace_atragmx","mas_cia_jsog","ace_microdagr","A3_Characters_F","tfar_core","USP_Gear_Head","CUP_Creatures_Military_USArmy","CUP_Weapons_M72A6","USP_Gear_Body","CUP_Creatures_Extra_OpsCore"};
	};
};
